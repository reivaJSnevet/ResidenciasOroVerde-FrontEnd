    ...
    return (
        <form className="max-w-md mx-auto p-6 ">
          ...
          <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
            ...
            <input type="search" id="default-search" className="block w-full p-4 pl-10 text-sm rounded-lg border border-gray-400" placeholder=""  value={filtro} onChange={handleChange} required />
