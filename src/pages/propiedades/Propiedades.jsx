        ...
        <div>
            ...
            <div className="container grid grid-cols-1 gap-3 mx-auto mt-12 lg:grid-cols-3">
               {filteredProperties.map(property => (
                    <div key={property.id} className="max-w-xs bg-white border border-gray-200 rounded-lg shadow lg:max-w-sm">
                        <a href="#">
                            <img className="object-cover w-full h-64 rounded-t-lg" src={property.photos.split(',')[0]} alt="Property" />
                        </a>
                        <div className="p-5">
                            <a href="#">
