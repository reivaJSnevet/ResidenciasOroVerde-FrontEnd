...
const HeaderHome2 = ({ topSales = [], topRents = [] }) => {
  ...
  const navBgClass =
    showRentCards || showSaleCards ? "bg-white text-black" : "text-white";

  return (
    <header
      id="header-home2"
      className={`z-40 flex items-center justify-between w-full px-10 fixed ${navBgClass} transition-colors duration-1000`}
    >
      ...
      <Navbar
        topRents={topRents}
        topSales={topSales}
        showRentCards={showRentCards}
        showSaleCards={showSaleCards}
        setShowRentCards={setShowRentCards}
        setShowSaleCards={setShowSaleCards}
      />
